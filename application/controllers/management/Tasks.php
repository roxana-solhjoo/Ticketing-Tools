...
{  
    function __construct()
    {
        parent::__construct(); 
         ...
         $this->load->model('management/task_model');
     ...
     
    {
      ...
      $this->load->view('management/tasks/index',$data); 
    }
    function add()
    {
  ...
  { 
      ...
      if ( ! $this->upload->do_upload('filename'))
      {
       // echo "test";///die;
              ...
              print_r($error);die;
              $this->load->view('management/tasks/add', $error);
      }
      else
      {
    ...
    redirect('management/tasks/index' ,$data);
  }
  else{
    $this->load->view('management/tasks/add', $data);
  }
}
    function edit($id)
     {
      ...
      //  die;
       ...
       $this->load->view('management/tasks/edit', $data);
  ...
  { 
      ...
      {
              $error = array('error' => $this->upload->display_errors());
              $this->load->view('management/tasks/edit', $error);
      }
      else
      {
            $image_data = $this->upload->data();
                ...
                //$data['file'] = $this->tasks_model->update($image_name);
      ...
      $this->session->set_flashdata ('success','Taks updated Sucessfully');
      redirect('management/tasks/index');
      }else{
        $data['tasks'] = $this->task_model->getById($id); 
       $data['company_name'] = $this->task_model->getAllCompanyName();
    ...
    //print_r($_REQUEST);
     ...
     //}
       ...
       $data['company_name'] = $this->task_model->getAllCompanyName();
        ...
        //  print_r($data);
        // die;
       $this->load->view('management/tasks/taskView', $data);
    }
   ...
   function get_pdf_test($id)
    {
      ...
      $html = $this->load->view('management/tasks/tasksPdf', $data,true);
