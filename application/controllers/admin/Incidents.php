...
if ($this->form_validation->run() ==true)
    ...
    function edit($id)
     {
       ...
       $data['company_name'] = $this->incidents_model->getAllCompanyName();
        $data['clients'] = $this->incidents_model->getAllClients();
       $this->load->view('admin/incidents/edit', $data);
    } 
  ...
  { 
    ...
    //     die;
      ...
      {
              $error = array('error' => $this->upload->display_errors());
              $this->load->view('admin/incidents/edit', $error);
      }
      else
      {
            $image_data = $this->upload->data();
      ...
      redirect('admin/incidents/index');
      }else{
        $data['incidents'] = $this->incidents_model->getById($id); 
        $data['company_name'] = $this->incidents_model->getAllCompanyName();
  ...
  function getAllStaff()
  {
   ...
   function incidentsView($id)
   {
     ...
     $data['company_name'] = $this->incidents_model->getAllCompanyName();
      //  echo "<pre>";
      // print_r($data);die;
     $this->load->view('admin/incidents/incidentsView',$data);
   }
  ...
  function get_pdf_test($id)
  {
    ...
    $path = '/tmp/mpdf'; 
     ...
     $mpdf->Output('incidentsPdf.pdf','D'); 
      ...
      //$path = file_get_contents('http://localhost:8080/ticketing_tool_v2/uploads');
