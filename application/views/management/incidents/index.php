      ...
      <div class="col-md-8">
          <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo site_url ('management_incidents_add');?>"> Add Incident</li>
            </ol>
        </nav>
      </div> 
      <div class="col-md-4">
         <a href="<?php echo site_url ('management_incidents_add');?>"><button class="btn btn-outline-primary float-right"  id="addIncidents"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Incidents</button></a>
                ...
                <table id="table_id" class="display">
                    ...
                    <?php
                     foreach($incidents as $n)
                     {
                        ?>
                        <tr >
                            <td><a href="<?php echo site_url ('management_incidentsView/' .$n->id);?>"> <?php echo "aaaa_IN".str_pad($n->incidents_id, '4', '0', STR_PAD_LEFT);?></a></td>
                            ...
                            <td><a class="edit" href="<?php echo site_url('management_incidents_edit/'.$n->id);?>"><i class="fa fa-pencil-square-o"></i></a>&nbsp
                             <a class="delete" href="<?php echo site_url ('management_incidents_delete/'.$n->id);?>"onclick="return confirm('Are you sure want to Delete this Record?')"><i class="fa fa-trash-o"></i></a>&nbsp</td>
                        </tr>
                        <?php
                        }
                        ?>
...
$(document).ready(function () {
  $('#InProgress').click(function(){
    $.ajax({
      method: "post",
      url:"<?php echo base_url(); ?>management_InProgressIncidents",
  ...
  $('#OnHold').click(function(){
    $.ajax({
      method: "post",
      url:"<?php echo base_url(); ?>management_OnHoldIncidents",
      dataType: "json",
     success: function(response) {
       console.log(response);
       $('#table_id').dataTable().fnDestroy();
  ...
  $('#Completed').click(function(){
    $.ajax({
      method: "post",
      url:"<?php echo base_url(); ?>management_CompletedIncidents",
      dataType: "json",
     success: function(response) {
       console.log(response);
       $('#table_id').dataTable().fnDestroy();
  ...
  $('#Open').click(function(){
    $.ajax({
      method: "post",
      url:"<?php echo base_url(); ?>management_OpenIncidents",
      dataType: "json",
     success: function(response) {
       console.log(response);
       $('#table_id').dataTable().fnDestroy();
  ...
  $('#Total').click(function(){
    $.ajax({
      method: "post",
      url:"<?php echo base_url(); ?>management_TotalIncidents",
      dataType: "json",
     success: function(response) {
       console.log(response);
       $('#table_id').dataTable().fnDestroy();
