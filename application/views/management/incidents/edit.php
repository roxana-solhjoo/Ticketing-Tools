...
<div class="main-sec"> 
  <div class="row">
      ...
      <div class="main-sec-contant"> 
        ...
        <?php echo form_open_multipart('management/incidents/update/'.$incidents->id);?>      
          <div class="row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <select class="form-control" id="Cname" name="Cname" >
                   <?php 
                    ...
                    {
                     if($row->company_name == $incidents->company_name){
               ...
               <div class="form-group col-md-4">
                  <a href="<?=base_url('management/incidents/downloadFile/' .$incidents->incidents_id)?>">Download file </a>
                </div>
              <?php } ?>
           ...
           <div class="col-md-12">
            <div class="btn-section float-right">
              ...
              <a href="<?php echo site_url ('management_incidents');?>"><button class="btn btn-danger float-right" id="cancelTasks" type="button" name="cancel"  ><i class="fa fa-plus-circle" aria-hidden="true" href="<?php echo site_url('management_incidents');?>"></i> Cancel</button></a>
            </div>
        </div>
         </div>
      </form>
