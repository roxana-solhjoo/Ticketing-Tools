        ...
        <div class="col-md-3">
          <div class="card-block">
            <div class="media">
              ...
              <a href="<?php echo base_url('management_project');?>">
        ...
        <div class="col-md-3">
          <div class="card-block">
            <div class="media">
              ...
              <div class="media-body ml-3">
              <a href="<?php echo base_url('management_staff');?>">
        ...
        <div class="col-md-3">
          <div class="card-block">
            <div class="media">
              ...
              <div class="media-body ml-3">
              <a href="<?php echo base_url('management_tasks');?>">
        ...
        <div class="col-md-3">
          <div class="card-block">
            <div class="media">
              ...
              <div class="media-body ml-3">
              <a href="<?php echo base_url('management_incidents');?>">
        ...
        <div class="col-md-3">
          <div class="card-block">
            <div class="media">
              ...
              <div class="media-body ml-3">
                <a href="<?php echo base_url('management_incidents/InProgress');?>">
        ...
        <div class="col-md-3"> 
          <div class="card-block">
            <div class="media">
              ...
              <div class="media-body ml-3">
                <a href="<?php echo base_url('management_incidents/Completed');?>">
        ...
        <div class="col-md-3">
          <div class="card-block">
            <div class="media">
              ...
              <div class="media-body ml-3">
                <a href="<?php echo base_url('management_incidents/Open');?>">
        ...
        <div class="col-md-3">
          <div class="card-block">
            <div class="media">
              ...
              <div class="media-body ml-3">
                <a href="<?php echo base_url('management_incidents/OnHold');?>">
