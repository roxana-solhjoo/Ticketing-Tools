...
<div class="main-sec">
  <div class="row">
      ...
      <div class="col-md-4">
       <a href="<?php echo site_url ('management/profile/edit/');?>"><button class="btn btn-outline-primary float-right"  id=""><i class="fa fa-plus-circle" aria-hidden="true"></i> Edit Profile</button></a>
      </div>
  </div>
        ...
        <h2 class="heading">Profile</h2>
             <div class="row">
               <div class="col-md-3">
				...
				<?php } ?>
					  <?php //echo $error;?>
					  <!-- <img src="<?php echo base_url('management_uploads/');?>" alt=""/>-->
                     <?php echo form_open_multipart('management/profile/do_upload');?>
                    ...
                    ?>
                                ...
                                foreach($task_list as $n)
                                  {
			                        ...
			                        <tr>
			                           <td><a id="TaskView"><?php echo "aaaa_I".str_pad($n->tasks_id, '3', '0', STR_PAD_LEFT);?></a></td>
			                            ...
			                            <!-- <td><?php echo $n->estimitate_hours;?></td> -->
                        ...
                        <div class="tab-pane fade" id="Incidents" role="tabpanel" aria-labelledby="profile-tab">
			                    ...
			                    <tbody>
			                        ...
			                        <tr>
			                           <td><a id="TaskView"><?php echo "aaaa_I".str_pad($n->incidents_id, '3', '0', STR_PAD_LEFT);?></a></td>
			                            ...
			                            <td><?php echo $n->start_date;?></td>
			                            <td><?php echo $n->end_date;?></td>
			                            <!-- <td><?php echo $n->estimate_hours;?></td> -->
			                            <td><a class="pro-circle"><img class="img-sm" src="<?php echo site_url ('assets/image/man.png');?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $n->first_name;?>" data-original-title="Click to deactivate the user"></a>&nbsp&nbsp </td>
			                            <td><span class="badge badge-danger"><?php echo $n->priority;?></span></td>
			                            <td>
			                                <ul class="dropdown-menu-status" style="list-style-type: none;padding-left: 0;">
                         ...
                         <div class="tab-pane fade " id="ChangePass" role="tabpanel" aria-labelledby="profile-tab">
							<div class="row">
							  <form action="<?php echo site_url('management_edit_password');?>" method="post">  
							    <!--<div class="form-group col-md-6">
								...
								<div class="alert-danger"><?php echo form_error('ConfPass'); ?></div>
								 ...
								 <div class="col-md-12">
                                  <div class="btn-section float-right">
                                     ...
                                     <a href="<?php echo site_url ('management_myProfile');?>"><button class="btn btn-danger float-right" id="cancelTasks" type="button" name="cancel"><i class="fa fa-plus-circle" aria-hidden="true" href="<?php echo site_url('management_myProfile');?>"></i> Cancel</button></a>
                                 </div>			
						 </div>
						 </form>
                    </div>
