      ...
      <div class="col-md-8">
        <nav> 
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo site_url ('management_myProfile');?>">Profile</a></li>
   ...
   <div class="ProjectsAdd" >
      <div class="tab-content profile-tab" id="myTabContent">
         <div class="tab-pane fade show active" id="About" role="tabpanel" aria-labelledby="home-tab">
	      	<form action="<?php echo site_url('management/profile/update/'.$userInfo->user_id);?>" method="post">      
		      <div class="row">
