      ...
      <div class="col-md-8">
          <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo site_url ('management_project_add');?>">Add Projects</a></li>
            </ol>
        </nav>
      </div>
      <div class="col-md-4">
       <a href="<?php echo site_url ('management_project_add');?>"><button class="btn btn-outline-primary float-right"  id="addProjects"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Projects</button></a>
                ...
                <tbody>
                    ...
                    foreach($project as $n)
                    {
                        ...
                        <tr>
                            ...
                            <td><a class="edit" href="<?php echo site_url('management_project_edit/'.$n->id);?>"><i class="fa fa-pencil-square-o" ></i></a>&nbsp&nbsp
                            <a class="delete"  href="<?php echo site_url('management_project_delete/'.$n->id);?>"  onclick="return confirm('Are you sure want to Delete this Record?')"><i class="fa fa-trash-o"></i></a></td>
                        </tr>
                    <?php
                    }
                    ?>
