...
<div class="staffAdd">
        <h2 class="heading">Edit Staff</h2>
         <form action="<?php echo site_url('management/staff/update/'.$staff->id);?>" method="post">
        <div class="row">
          <div class="form-group col-md-4">
               ...
               <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                  ...
                  <select  class="form-control" id="Subcom"  name="Subcom" value="<?php echo $staff->company_name;?>">
                   <?php 
                    foreach($company_name as $row )
                    {
                     if($row->company_name == $staff->company_name){
           ...
           <div class="col-md-12">
             <div class="btn-section float-right">
                ...
                <a href="<?php echo site_url ('management_staff');?>"><button class="btn btn-danger float-right" id="cancelStaff"type="button" name="cancel" href="<?php echo site_url('management_staff');?>" > <i class="fa fa-plus-circle" aria-hidden="true"></i> Cancel</button>
            </div> 
        </form>
    </div>
  </div>
