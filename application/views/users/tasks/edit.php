  ...
  <div class="row">
    ...
    <div class="main-sec-contant">  
      <div class="TasksAdd" >
        ...
        <?php echo form_open_multipart('users/tasks/update/'.$tasks->id);?>     
          <div class="row">
               ...
               <div class="form-group col-md-4">
                  <a href="<?=base_url('users/tasks/downloadFile/' .$tasks->tasks_id)?>">Download file </a>
                </div>
           <div class="col-md-12">
            <div class="btn-section float-right">
                <button class="btn btn-outline-primary"><i class="fa fa-plus-circle" aria-hidden="true"></i> update</button>
              <a href="<?php echo site_url ('front_tasks');?>"><button class="btn btn-danger float-right" id="cancelTasks" type="button" name="cancel"  ><i class="fa fa-plus-circle" aria-hidden="true" href="<?php echo site_url('front_tasks');?>"></i> Cancel</button></a>
            </div>
        </div>
         </div>
     </form>
