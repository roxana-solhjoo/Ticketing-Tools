...
<div class="main-sec"> 
  <div class="row">
      ...
      <div class="main-sec-contant"> 
        ...
        <?php echo form_open_multipart('manager_incidentUpdate/'.$incidents->id);?>     
          <div class="row">
               ...
               <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                  ...
                  <?php 
                    ...
                    {
                     if($company_name->company_name == $incidents->company){
               ...
               <?php if(!empty($incidents->file)){ ?>
                <div class="form-group col-md-4">
                  <a href="<?=base_url('manager/incidents/downloadFile/' .$incidents->incidents_id)?>">Download file </a>
                </div>
              <?php } ?>
