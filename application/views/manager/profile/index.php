...
<div class="main-sec">
  <div class="row">
      ...
      <div class="col-md-4">
       <a href="<?php echo site_url ('manager/profile/edit/');?>"><button class="btn btn-outline-primary float-right"  id=""><i class="fa fa-plus-circle" aria-hidden="true"></i> Edit Profile</button></a>
      </div>
  </div>
             ...
             <div class="row">
               <div class="col-md-3">
				...
				<?php } ?>
                     ...
                     <?php echo form_open_multipart('manager/profile/do_upload');?>
                    ...
                    ?>
                        ...
                        <div class="tab-pane fade" id="Incidents" role="tabpanel" aria-labelledby="profile-tab">
                         ...
                         <div class="tab-pane fade " id="ChangePass" role="tabpanel" aria-labelledby="profile-tab">
							<div class="row">
							  <form action="<?php echo site_url('manager_edit_password');?>" method="post">  
							    <!--<div class="form-group col-md-6">
								...
								<div class="alert-danger"><?php echo form_error('ConfPass'); ?></div>
								 ...
								 <div class="col-md-12">
                                  <div class="btn-section float-right">
                                     ...
                                     <a href="<?php echo site_url ('manager_myProfile');?>"><button class="btn btn-danger float-right" id="cancelTasks" type="button" name="cancel"><i class="fa fa-plus-circle" aria-hidden="true" href="<?php echo site_url('manager_myProfile');?>"></i> Cancel</button></a>
                                 </div>			
						 </div>
						 </form>
                    </div>
