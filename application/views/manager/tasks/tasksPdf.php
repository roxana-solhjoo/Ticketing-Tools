...
<div class="main-sec">
  ...
  <div class="TaskView" > 
        <h3 class="breadcrumb" ><?php echo "aaaa_IN".str_pad($tasks['tasks_id'], '4', '0', STR_PAD_LEFT);?></h3>
        <div class="row">
               <div class="form-group col-md-4">
               <h5>   <label for="email">Tasks ID</label></h5>
                  <input type="text" class="form-control" id="T_id" placeholder="Name" name="T_id" value="<?php echo "aaaa_IN".str_pad($tasks['tasks_id'], '4', '0', STR_PAD_LEFT);?>" readonly>
                </div>
               <div class="form-group col-md-4">
                 <h5> <label for="email">Tasks Name</label></h5>
                ...
                <h5>  <label for="pwd">Company Namey</label></h5>
                  <input type="text" class="form-control" id="Cname" name="Cname" value="<?php echo $tasks['company_name'];?>" readonly>
                </div>

                <div class="form-group col-md-4">
                  <h5><label for="pwd">Project Name</label></h5>
                  <input type="text" class="form-control" id="Pname" name="Pname" value="<?php echo $tasks['project_name'];?>" readonly>
                </div>
                <div class="form-group col-md-4">
                 <h5> <label for="pwd">Project Version</label></h5>
                  <input  type="text" class="form-control" id="Pversion" name="Pversion" value="<?php echo $tasks['project_version'];?>" readonly >
                </div> 
                <div class="form-group col-md-4">
                 <h5> <label for="pwd">Report From</label></h5>
                  <input  type="text" class="form-control" id="Rform" name="Rform" value="<?php echo $tasks['report_form'];?>" readonly >
                </div>
                <div class="form-group col-md-4">
                  <h5><label for="pwd">Assign To</label></h5>
                  <input  type="text" class="form-control" id="Assignto" name="Assignto" value="<?php echo $tasks['assign_to'];?>" readonly>
                </div>
                 <div class="form-group col-md-4">
                 <h5> <label for="pwd">Start Date</label></h5>
                  <input  type="text" class="form-control" id='Sdate' name='Sdate' value="<?php echo $tasks['start_date'];?>" readonly>
                </div>
                <div class="form-group col-md-4">
                  <h5><label for="pwd">End Date</label></h5>
                  <input  type="text" class="form-control" id='Edate' name='Edate' value="<?php echo $tasks['end_date'];?>" readonly>
                </div>
                <div class="form-group col-md-4">
                  <h5><label for="pwd">Status</label></h5>
                  <input type="text" class="form-control" id="Status" name="Status" value="<?php echo $tasks['status'];?>" readonly>
                </div>
                <div class="form-group col-md-4">
                 <h5> <label for="pwd">Priority</label></h5>
                  <input   type="text" class="form-control" id="Priority" name="Priority" value="<?php echo $tasks['priority'];?>" readonly>
                </div>
                <div class="form-group col-md-4">
                 <h5> <label for="email">Description</label></h5>
           ...
           <div class="main-two "> 
             <div class="breadcrumb" > 
               <h5> <label  for="pwd">Task's History</label></h5>
             </div>  
             <div class="col-md-12 " >
                <div id="accordion">
                <?php 
