  ...
  <div class="row">
    ...
    <div class="main-sec-contant"> 
      <div class="TasksAdd" >
        ...
        <?php echo form_open_multipart('manager_taskUpdate/'.$tasks->id);?>     
          <div class="row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <select class="form-control" id="Cname" name="Cname">
                   <?php 
                    ...
                    {
                     if($company_name->company_name == $tasks->company_name){
               ...
               ?> 
                ...
                <div class="form-group col-md-4">
                  <a href="<?=base_url('manager/tasks/downloadFile/' .$tasks->tasks_id)?>">Download file </a>
                </div>
           <div class="col-md-12">
            <div class="btn-section float-right">
                <button class="btn btn-outline-primary"><i class="fa fa-plus-circle" aria-hidden="true"></i> update</button>
              <a href="<?php echo site_url ('manager_tasks');?>"><button class="btn btn-danger float-right" id="cancelTasks" type="button" name="cancel"  ><i class="fa fa-plus-circle" aria-hidden="true" href="<?php echo site_url('manager_tasks');?>"></i> Cancel</button></a>
            </div>
        </div>
         </div>
     </form>
...
<script>
  ...
  if(company_name != '')
  {
   ...
   $.ajax({
    url:"<?php echo base_url(); ?>manager_getProjectList",
    method:"POST",
    //dataType :'JSON',
 ...
 var project_name = "<?php echo $tasks->project_name;?>";
  if(project_name != '')
  {
   ...
   $.ajax({
    url:"<?php echo base_url(); ?>manager_getstaffsList",
    method:"POST",
    //dataType :'JSON',
