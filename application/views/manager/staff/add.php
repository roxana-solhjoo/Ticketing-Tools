  ...
  <div class="main-sec-contant">
    <div class="staffAdd">
        <h2 class="heading">Add Staff</h2>
           <?php echo form_open('manager_staff_add'); ?>
        <div class="row">
          <div class="form-group col-md-4">
           ...
           <div class="col-md-12">
            <div class="btn-section float-right">
              ...
              <a href="<?php echo site_url ('manager_staff');?>"><button class="btn btn-danger float-right" id="cancelStaff" type="button" name="cancel"  ><i class="fa fa-plus-circle" aria-hidden="true" href="<?php echo site_url('manager_staff');?>"></i> Cancel</button></a>
            </div>
            </form>
        </div>
     </div>
