...
<div class="main-sec">
  ...
  <div class="main-sec-contant">
    <div class="ProjectsAdd" >
        ...
        <form action="<?php echo site_url('manager_project_update/'.$project->id);?>" method="post">
        <div class="row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <select class="form-control" id="company" name="PassignTo">
                   <?php 
                    ...
                    // {
                     if($company_name->company_name == $project->company){
...
$(document).ready(function(){
  ...
  if(company_name != '')
  {
    ...
    //alert(support_staff);
    $.ajax({
    url:"<?php echo base_url(); ?>manager_getAllStaffsList",
    method:"POST",
    //dataType :'JSON',
