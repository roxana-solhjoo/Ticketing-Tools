...
<nav class="navbar navbar-expand-lg navbar-cus navbar-light bg-faded">
  <a class="navbar-brand waves-light" href="<?php echo site_url ('manager_dashboard');?>">
            ...
            <ul class="nav navbar-nav ml-auto nav-head-font">
              ...
              <li class="nav-item dropdown dropdown-mob" id="dropdown-mob-hide">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="<?php echo site_url('manager_myProfile');?>" class="dropdown-item"><i class="fa fa-address-book-o" aria-hidden="true"></i>My Profile</a>
                        <a href="<?php echo site_url ('manager/profile/edit/');?>" class="dropdown-item"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit Profile</a>
  ...
  <div class="fixed-nav">
    <div class="fixed-nav-inner open-nav">
      <ul class="text-center">
        <a href="<?php echo site_url('manager_dashboard');?>" id="menu-toggle" class="waves-light menu-toggle" data-toggle="offcanvas">
          <li>
            <i class="fa fa-dashboard"></i></li>
            <li>Menu</li>
        </a>
        <!-- <a href="<?php echo site_url('manager_company');?>" class="waves-light">
          <li><i class="fa fa-briefcase"></i></li>
          <li>Company</li>
        </a> -->
        <a href="<?php echo site_url('manager_staff');?>" class="waves-light">
          <li><i class="fa fa-user-circle"></i></li>
          <li>Staff</li>
        </a>
        <a href="<?php echo site_url('manager_project');?>" class="waves-light">
          <li><i class="fa fa-product-hunt"></i></li>
          <li>Projects</li>
        </a>
        <a href="<?php echo site_url('manager_incidents');?>" class="waves-light">
          <li><i class="fa fa-ticket"></i></li>
          <li>Incidents</li>
        </a>
        <a href="<?php echo site_url('manager_tasks');?>"class="waves-light">
          <li><i class="fa fa-ticket"></i></li>
          <li>Tasks </li>
        </a>
        <!-- <a href="<?php echo site_url('setting');?>" class="waves-light">
