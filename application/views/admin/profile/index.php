...
<div class="main-sec">
  <div class="row">
      ...
      <div class="col-md-4">
       <a href="<?php echo site_url ('admin/profile/edit/');?>"><button class="btn btn-outline-primary float-right"  id=""><i class="fa fa-plus-circle" aria-hidden="true"></i> Edit Profile</button></a>
      </div>
  </div>
                    ...
                    ?>
                        ...
                        <div class="tab-pane fade" id="Incidents" role="tabpanel" aria-labelledby="profile-tab">
                         ...
                         <div class="tab-pane fade " id="ChangePass" role="tabpanel" aria-labelledby="profile-tab">
							<div class="row">
							  <form action="<?php echo site_url('edit_password');?>" method="post">  
							    <!--<div class="form-group col-md-6">
