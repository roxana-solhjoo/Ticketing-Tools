    ...
    <div class="SettingsDetails">
        ...
        <div class="row">
            <div class="col-md-12">
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="pill" href="#menu4">Clients Settings</a>
              </li>
            </ul>
            ...
            <div class="tab-content">
                    ...
                    foreach($role as $n)
                    {
                        ...
                        <tr>
                            ...
                            <td><?php echo $n->description?></td>
                             <td>
                             <a  class="edit" onclick="GetDetails('<?php echo $n->id;?>');" data-target="#EditeRole" data-backdrop="static" data-keyboard="false" data-toggle="modal" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp&nbsp<a class="delete"  href="<?php echo site_url('admin/settings/Delete/'.$n->id);?>"onclick="return confirm('Are you sure want to Delete this Record?')"><i class="fa fa-trash-o"></i></a></td>
                             <!-- <button class="btn btn-outline-primary float-right" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#AddRole"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Role</button> -->
              ...
              <form id="emailSettings" action="<?php echo site_url('admin/settings/create');?>" method="post">
                <div class="row">
                    <div class="form-group col-md-4">
                      ...
                      <div class="col-md-12">
                        <div class="btn-section float-right">
                         ...
                         <a href="<?php echo site_url ('setting');?>"><button class="btn btn-danger float-right" id="cancelCompany" type="button" ><i class="fa fa-plus-circle" aria-hidden="true"></i> Cancel</button></a>
                       </div>
                     </div>
                  </div>
              </form>
              ...
              <div id="menu4" class="tab-pane fade"><br>
                 <div class="row">
                  <div class="col-md-8">
                      <h3 class="heading-tab">Clients</h3>
                  </div>
                  <div class="col-md-4">
                      <button class="btn btn-outline-primary float-right" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#AddClient">
                      <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Client</button>
                  </div>
                  </div>
                    ...
                    foreach($clients as $n)
                    {
                        ...
                        <tr>
                            ...
                            <td><?php echo $n->client_name; ?></td>
                             ...
                             <td><a class="edit" data-target="#EditClient" onclick="getClientsDetails('<?php echo $n->id;?>');"  data-backdrop="static" data-keyboard="false"  data-toggle="modal"><i class="fa fa-pencil-square-o"></i></a>&nbsp&nbsp<a class="delete" href="<?php echo site_url('admin/settings/DeleteClient/'.$n->id);?>"onclick="return confirm('Are you sure want to Delete this Record?')"><i class="fa fa-trash-o"></i></a></td>
                        </tr>
                         <?php
                           $i++; }
                          ?>
...
<div class="modal fade" id="AddRole">
  <div class="modal-dialog">
   <form id="AddRoleForm" action="<?php echo site_url('admin/settings/addRole');?>" method="post">
...
<div class="modal fade" id="AddDepartment">
  <div class="modal-dialog">
   <form id='AddDepartmentForm' action="<?php echo site_url('admin/settings/addDepartment');?>" method="post">
    <div class="modal-content">
...
<div class="modal fade" id="AddTeam">
  <div class="modal-dialog">
    <form  id ='AddTeamForm' action="<?php echo site_url('admin/settings/addTeam');?>" method="post">
...
<div class="modal fade" id="AddClient">
  <div class="modal-dialog">
    <form  id ='AddClientForm' action="<?php echo site_url('admin/settings/addClient');?>" method="post">
...
<div class="modal fade" id="EditeRole">
  <div class="modal-dialog">
    <form id="EditeRoleForm" action="<?php echo site_url('admin/settings/update_role');?>" method="post">
...
<div class="modal fade" id="EditDepartment">
  <div class="modal-dialog">
    <form id="EditDepartmentForm" action="<?php echo site_url('admin/settings/update_Department');?>" method="post">
...
<div class="modal fade" id="EditTeam">
  <div class="modal-dialog">
    <form id="#EditTeamForm" action="<?php echo site_url('admin/settings/update_Team');?>" method="post">
...
<div class="modal fade" id="EditClient">
  <div class="modal-dialog">
    <form id="#EditClientForm" action="<?php echo site_url('admin/settings/update_client');?>" method="post">
        <input type="hidden" id="CEditRow" name="CEditRow" value= "">
      <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
            <div class="form-group col-md-12">
              <label for="email">Client Name</label>
              <input type="text" class="form-control" id="Cnames" placeholder="Client Name" name="Cname" value="<?php //echo $role->role_name;?>" required>
            </div>
           </div>
        </div>
...
function GetDetails(id){
  $.ajax({
    url: "<?php echo site_url('admin/settings/edit');?>",
    data:{
      id: id,
    },
    type : 'GET',
...
function GetDepartmentDetails(id){
  $.ajax({
    url: "<?php echo site_url('admin/settings/edit_department');?>",
    data:{
      id: id,
    },
    type : 'GET',
...
function getTeamDetails(id){
  $.ajax({
    url: "<?php echo site_url('admin/settings/edit_team');?>",
    data:{
      id: id,
    },
    type : 'GET',
...
function getClientsDetails(id){
  $.ajax({
    url: "<?php echo site_url('admin/settings/edit_clients');?>",
    data:{
      id: id,
    },
    type : 'GET',
