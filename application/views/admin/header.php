...
<nav class="navbar navbar-expand-lg navbar-cus navbar-light bg-faded">
  <a class="navbar-brand waves-light" href="<?php echo base_url ('dashboard');?>">
       ...
       <span class="navbar-toggler-icon"></span>
          ...
          <div class="collapse navbar-collapse navbar-mob-bar" id="navbarNav">
            <ul class="nav navbar-nav ml-auto nav-head-font">
              <li class="nav-item active"><a class="nav-link" href="<?php echo base_url ('setting');?>"><i class="fa fa-cog" aria-hidden="true"></i></a></li>
              ...
              <li class="nav-item dropdown dropdown-mob" id="dropdown-mob-hide">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="<?php echo base_url('myProfile');?>" class="dropdown-item"><i class="fa fa-address-book-o" aria-hidden="true"></i>My Profile</a>
                        <a href="<?php echo base_url ('admin/profile/edit/');?>" class="dropdown-item"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit Profile</a>
                        ...
                        <a href="<?php echo base_url ('admin/dashboard/logout');?>" class="dropdown-item"><i class="fa fa-sign-out" aria-hidden="true"></i>Sign Out</a>
                    </div>
                </li>
            </ul>
        </div>
  ...
  <div class="fixed-nav">
    <div class="fixed-nav-inner open-nav">
      <ul class="text-center">
        <a href="<?php echo base_url('dashboard');?>" id="menu-toggle" class="waves-light menu-toggle" data-toggle="offcanvas">
          <li>
            <i class="fa fa-dashboard"></i></li>
            <li>Menu</li>
        </a>
        <a href="<?php echo base_url('company');?>" class="waves-light">
          <li><i class="fa fa-briefcase"></i></li>
          <li>Company</li>
        </a>
        <a href="<?php echo base_url('staff');?>" class="waves-light">
          <li><i class="fa fa-user-circle"></i></li>
          <li>Staff</li>
        </a>
        <a href="<?php echo base_url('project');?>" class="waves-light">
          <li><i class="fa fa-product-hunt"></i></li>
          <li>Projects</li>
        </a>
        <a href="<?php echo base_url('incidents');?>" class="waves-light">
          <li><i class="fa fa-ticket"></i></li>
          <li>Incidents</li>
        </a>
        <a href="<?php echo base_url('tasks');?>"class="waves-light">
          <li><i class="fa fa-ticket"></i></li>
          <li>Tasks </li>
        </a>
        <a href="<?php echo base_url('setting');?>" class="waves-light">
