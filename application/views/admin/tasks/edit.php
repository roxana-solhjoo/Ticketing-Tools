  ...
  <div class="row">
      <div class="col-md-8"> 
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo site_url ('admin/tasks');?>">Tasks</a></li>
    ...
    <div class="main-sec-contant"> 
      <div class="TasksAdd" >
        ...
        <?php echo form_open_multipart('admin/tasks/update/'.$tasks->id);?>      
          <div class="row">
               ...
               ?> 
                ...
                <div class="form-group col-md-4">
                  <a href="<?=base_url('admin/tasks/downloadFile/' .$tasks->tasks_id)?>">Download file </a>
                </div>
                
           <div class="col-md-12">
            <div class="btn-section float-right">
                <button class="btn btn-outline-primary"><i class="fa fa-plus-circle" aria-hidden="true"></i> update</button>
              <a href="<?php echo site_url ('tasks');?>"><button class="btn btn-danger float-right" id="cancelTasks" type="button" name="cancel"  ><i class="fa fa-plus-circle" aria-hidden="true" href="<?php echo site_url('tasks');?>"></i> Cancel</button></a>
            </div>
        </div>
         </div>
     </form>
...
<script>
  ...
  if(company_name != '')
  {
   ...
   $.ajax({
    url:"<?php echo base_url(); ?>getProjectList",
    method:"POST",
    //dataType :'JSON',
 ...
 var project_name = "<?php echo $tasks->project_name;?>";
  if(project_name != '')
  {
   ...
   $.ajax({
    url:"<?php echo base_url(); ?>getstaffsList",
    method:"POST",
    //dataType :'JSON',
