      ...
      <div class="col-md-8">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url ('admin/incidents');?>">Incidents</a></li>
...
<div class="TaskView" > 
        <h2 class="heading" ><?php echo "aaaa_IN".str_pad($incidents->incidents_id, '4', '0', STR_PAD_LEFT);?></h2>
          <form action="<?php echo base_url('get_pdf_test/'.$incidents->id);?>"  >      
        <div class="row">
               ...
               <div class="form-group col-md-4">
                ...
                <!-- <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control"  id="Ehours" name="Ehours" value="<?php echo $incidents->estimate_hours;?>" readonly> 
                </div> -->
                <div class="form-group col-md-4">
