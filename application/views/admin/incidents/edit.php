...
<div class="main-sec"> 
  <div class="row">
      ...
      <div class="main-sec-contant"> 
        ...
        <?php echo form_open_multipart('admin/incidents/update/'.$incidents->id);?>      
          <div class="row">
           ...
           <div class="col-md-12">
            <div class="btn-section float-right">
              ...
              <a href="<?php echo site_url ('incidents');?>"><button class="btn btn-danger float-right" id="cancelTasks" type="button" name="cancel"  ><i class="fa fa-plus-circle" aria-hidden="true" href="<?php echo site_url('incidents');?>"></i> Cancel</button></a>
            </div>
        </div>
         </div>
      </form>
