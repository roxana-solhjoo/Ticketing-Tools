...
<div class="staffAdd">
        <h2 class="heading">Edit Staff</h2>
         <form action="<?php echo site_url('admin/staff/update/'.$staff->id);?>" method="post">
        <div class="row">
          <div class="form-group col-md-4">
               ...
               <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                  ...
                  <select  class="form-control" id="Subcom"  name="Subcom[]" value="<?php echo $staff->company_name;?>" multiple>
                   <?php 
                    foreach($company_name as $row )
                    {
                     if(in_array($row->id, $selectedCompany)){
                      echo '<option value="'.$row->id.'" selected=selected >'.$row->company_name.'</option>';
                     }else{
                ...
                <div class="form-group col-md-4">
                  ...
                  <select class="form-control" id="role" name="role" value="<?php echo $staff->role;?>">
                  <?php 
           ...
           <div class="col-md-12">
             <div class="btn-section float-right">
                ...
                <a href="<?php echo site_url ('staff');?>"><button class="btn btn-danger float-right" id="cancelStaff"type="button" name="cancel" href="<?php echo site_url('staff');?>" > <i class="fa fa-plus-circle" aria-hidden="true"></i> Cancel</button>
            </div> 
        </form>
    </div>
  </div>
   ...
   if( company_name!= ''&& role != '' && role != 'Manager' && role != 'Admin'&& role != 'Management Office')
    {
      //alert('ok');
       ...
       $.ajax({
         url:"<?php echo base_url()?>getMangerList",
         //type: "POST",
         method:"POST",
