      ...
      <div class="col-md-8"> 
          <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo site_url ('staff_add');?>">Add Staff</a></li>
            </ol>
        </nav>
      </div>
      <div class="col-md-4">
        <a href="<?php echo site_url ('staff_add');?>"><button class="btn btn-outline-primary float-right" id="addStaff"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Staff</button></a>
